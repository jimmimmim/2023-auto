...
export default function Map() { 
  ...
  let id = "391A8DD1-B808-4C3A-BBD5-9A91538AAA8F2023/01/12 14:16:44"
...
const onEachFeature = (feature, layer, e) => {
  ...
  let crosspoint = values[feature.properties.id]
  const gid = feature.properties.id_5m;
...
const gridStyle9 = (feature) => {
  ...
  if (!confirmed) {
      ...
      opacity: 0, // stroke opacity (default: 1.0)
      fillcolor: 'white',
      fillOpacity: 0
      }
